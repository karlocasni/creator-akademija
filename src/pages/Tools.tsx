    ...
    <div className="flex flex-col w-full max-w-full overflow-hidden pb-[24px]">
      ...
      <div className="pt-[24px] px-[16px] flex flex-col">
        <h1 className="font-heading font-[800] text-[28px] text-[#FFFFFF] leading-[1.1] mb-[4px] uppercase flex items-center gap-2">
          <span>CREATOR</span>
          <span className="text-[#3B82F6] font-marker font-normal tracking-normal mt-1">ALATI</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] p-[16px] mt-2">
        ...
        >
          ...
          <div className="flex flex-col gap-4 mt-2">
            <div className="w-[56px] h-[56px] rounded-full bg-[rgba(59,130,246,0.1)] text-[#3B82F6] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <Zap className="w-[28px] h-[28px] fill-[#3B82F6]/20" />
            </div>
            <div>
        ...
        >
          ...
          <div className="flex flex-col gap-4 mt-2">
            <div className="w-[56px] h-[56px] rounded-full bg-[rgba(59,130,246,0.1)] text-[#3B82F6] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <Flame className="w-[28px] h-[28px] fill-[#3B82F6]/20" />
            </div>
            <div>
        ...
        >
          ...
          <div className="flex flex-col gap-4 mt-2">
            <div className="w-[56px] h-[56px] rounded-full bg-[rgba(59,130,246,0.1)] text-[#3B82F6] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <Lightbulb className="w-[28px] h-[28px] fill-[#3B82F6]/20" />
            </div>
            <div>
        ...
        <div 
          ...
          className="bg-[#151E30] rounded-[20px] border border-[rgba(255,255,255,0.06)] p-[24px] relative overflow-hidden cursor-pointer hover:border-emerald-500/30 transition-colors group"
        >
