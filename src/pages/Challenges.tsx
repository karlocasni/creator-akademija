  ...
  return (
    <div className="flex flex-col w-full max-w-full overflow-hidden pb-[80px]">
      ...
      <div className="px-[16px] flex flex-col gap-5">
        ...
        {activeChallenge ? (
          ...
          >
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <span className="font-mono text-[#3B82F6] text-[9px] font-bold uppercase tracking-[0.2em] block mb-1">
                  Aktivni Challenge
                </span>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-[#3B82F6] text-white rounded-full font-heading font-[800] text-[13px] uppercase hover:scale-[1.03] active:scale-[0.98] transition-transform"
              >
          ...
          <div className="bg-[#151E30] rounded-[24px] border border-[rgba(59,130,246,0.2)] p-[20px] flex flex-col gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Reci nam something o svom videu..."
                rows={3}
                ...
                {activeSubs.map(sub => (
                  <div
                    ...
                    className={`rounded-[20px] p-5 flex flex-col gap-3 ${
                      sub.isPinned
                        ? 'border-2 border-[#3B82F6] bg-gradient-to-br from-[rgba(59,130,246,0.1)] to-[#151E30]'
                  ...
                  >
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 text-[13px] text-[#3B82F6] font-bold hover:underline truncate"
                    >
        ...
        {profile?.isAdmin && (
          <div className="bg-[#151E30] rounded-[24px] border border-[rgba(59,130,246,0.15)] p-[20px]">
            <button
              onClick={() => setShowAdminForm(v => !v)}
              className="w-full flex items-center justify-between text-[#3B82F6] font-heading font-[800] text-[14px] uppercase tracking-widest"
            >
            ...
            {showAdminForm && (
              <div className="mt-4 flex flex-col gap-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#3B82F6] text-white font-heading font-[800] text-[14px] rounded-full uppercase hover:scale-[1.02] transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {previousChallenges.map(c => (
                <div key={c.id} className="bg-[#151E30] rounded-[16px] border border-[rgba(255,255,255,0.04)] p-4 opacity-60">
