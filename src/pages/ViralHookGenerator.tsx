    ...
    <div className="flex flex-col w-full max-w-full overflow-hidden pb-[24px]">
      ...
      <div className="px-[16px] mt-6">
        ...
        <div className="bg-[#151E30] rounded-[24px] border border-[rgba(255,255,255,0.06)] p-[20px] relative overflow-hidden">
          ...
          <div className="bg-[#0E1420] border border-[rgba(255,255,255,0.04)] rounded-[16px] p-[16px] flex flex-col gap-[12px] relative">
            ...
            <div className={cn(
              ...
              isSpinning ? "bg-[#3B82F6]/5 text-[#3B82F6] border-[#3B82F6]/20 blur-[0.5px]" : "bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.04)] text-[#FFFFFF]"
            )}>
              {attention}
            </div>
            ...
            <div className={cn(
              ...
              isSpinning ? "bg-[#3B82F6]/5 text-[#3B82F6] border-[#3B82F6]/20 blur-[0.5px]" : "bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.04)] text-[#FFFFFF]/90"
            )}>
              {problem}
            </div>
            ...
            <div className={cn(
              ...
              isSpinning ? "bg-[#3B82F6]/5 text-[#3B82F6] border-[#3B82F6]/20 blur-[0.5px]" : "bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.04)] text-[#8B8FA8]"
            )}>
              {action}
            </div>
          </div>
          ...
          <div className="flex gap-[8px] mt-[16px]">
            <button
              onClick={rollSlots}
              disabled={isSpinning}
              className="flex-1 py-[14px] bg-[#3B82F6] text-[#FFFFFF] font-heading font-[700] text-[15px] rounded-full uppercase hover:scale-[1.02] active:scale-[0.98] transition-transform flex items-center justify-center gap-2 disabled:opacity-50"
            >
